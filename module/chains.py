...
class Chain:
    ...
    def extract_jobs(self, cleaned_text):
        prompt_extract = PromptTemplate.from_template(
            ...
            ### VALID JSON (NO PREAMBLE and only take mandatory skills ):
            """
        )
    ...
    def write_mail(self, job, links):
        prompt_email = PromptTemplate.from_template(
            ...
            ### INSTRUCTION:
            You are Mohan, a business development executive at some company. The Company is an AI & Software Consulting company dedicated to facilitating
            ...
            ### EMAIL (NO PREAMBLE and assume any name for company ):
